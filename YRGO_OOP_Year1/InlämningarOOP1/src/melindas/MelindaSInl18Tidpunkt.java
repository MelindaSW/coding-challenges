...
public class MelindaSInl18Tidpunkt {
	  ...
	  // instansvariabler
	   ...
	   // konstruktorer
	   public MelindaSInl18Tidpunkt() {}

	   public MelindaSInl18Tidpunkt(int tim, int min, int sek) {
	     sätt(tim, min, sek);
	   }

	   public MelindaSInl18Tidpunkt(int tim, int min) {
	     this(tim, min, 0);
			 visaSek = false; 
	   }

	   public MelindaSInl18Tidpunkt(MelindaSInl18Tidpunkt tp) {   // kopieringskonstruktor
