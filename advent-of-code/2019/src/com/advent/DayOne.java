...
*
* 1. read puzzle inputs from txt file to list
* 2. iterate through them?
* 3. Divide each value by 3, Round down. Subtract 2
* 4. Add together all the calculated values.
*
* Two:
...
public class DayOne {
    ...
    public static void main(String[] args) {
        ...
        List<Double> puzzleInputs = new ArrayList<Double>();
        Scanner s = null;
        Double result = 0.0;

        try {
            s = new Scanner(new File("C:\\Users\\sands\\Documents\\Projects\\advent-of-code\\day1-puzzle-input.txt"));
            while(s.hasNext()) {
                puzzleInputs.add(s.nextDouble());
            }
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }

        for (Double puzzleInput : puzzleInputs) {
            result += calculateFuelRequirements(puzzleInput);
        }

        System.out.println(result);
    }

    static double calculateFuelRequirements(Double fuel) {
